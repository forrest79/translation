...
class TracyBarPanel implements Translation\Logger, Tracy\IBarPanel
{
	...
	public function getPanel(): string
	{
		...
		return count($panel) > 0
				? '<h1>Missing translations: ' . $this->getUntranslatedCount() . '</h1>' .
					...
					'<style>#tracy-debug .translator-panel h2 {font-size: 23px;}</style>'
				: '';
	}
